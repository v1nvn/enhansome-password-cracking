...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 852 | 🐛 0 | 📅 2025-06-06 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 852 | 🐛 0 | 📅 2025-06-06
...
* [NPK](https://github.com/c6fc/npk) ⭐ 649 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-13 - NPK is a distributed hash-cracking platform built entirely of serverless components in AWS including Cognito, DynamoDB, and S3.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 25,415 | 🐛 298 | 🌐 C | 📅 2025-11-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*
...
* [Naive hashcat](https://github.com/brannondorsey/naive-hashcat) ⭐ 1,379 | 🐛 11 | 🌐 C | 📅 2022-01-10 - Naive hashcat is a plug-and-play script that is pre-configured with naive, emperically-tested, "good enough" parameters/attack types.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,714 | 🐛 236 | 🌐 PHP | 📅 2026-02-13 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [nsa-rules](https://github.com/NSAKEY/nsa-rules) ⭐ 559 | 🐛 0 | 🌐 Shell | 📅 2017-01-03 - Password cracking rules and masks for hashcat generated from cracked passwords.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 12,718 | 🐛 488 | 🌐 C | 📅 2026-01-17 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [PACK](https://github.com/iphelix/pack) ⭐ 867 | 🐛 9 | 🌐 Python | 📅 2019-12-10 - A collection of utilities developed to aid in analysis of password lists in order to enhance password cracking through pattern detection of masks, rules, character-sets and other password characteristics.
...
* [bopscrk](https://github.com/r3nt0n/bopscrk) ⭐ 1,055 | 🐛 7 | 🌐 Python | 📅 2024-09-07 - Generate smart and powerful wordlists for targeted attacks. Includes song lyrics fetching and different transforms.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 314 | 🐛 5 | 📅 2026-02-13 - This project aim to provide french word list about everything a person could use as a base password.
