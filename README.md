...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 920 | 🐛 0 | 📅 2026-03-15 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 920 | 🐛 0 | 📅 2026-03-15
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,363 | 🐛 1 | 🌐 C | 📅 2026-04-14 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 25,805 | 🐛 328 | 🌐 C | 📅 2026-02-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*
...
* [hat](https://github.com/sp00ks-git/hat) ⭐ 307 | 🐛 1 | 🌐 Python | 📅 2024-06-14 - An Automated Hashcat Tool for common wordlists and rules to speed up the process of cracking hashes during engagements.
...
* [fitcrack](https://github.com/nesfit/fitcrack) ⭐ 172 | 🐛 28 | 🌐 C | 📅 2026-04-13 - A hashcat-based distributed password cracking system.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 13,012 | 🐛 492 | 🌐 C | 📅 2026-04-13 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 5,875 | 🐛 48 | 🌐 Python | 📅 2025-12-26 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 318 | 🐛 5 | 📅 2026-04-18 - This project aim to provide french word list about everything a person could use as a base password.
...
* [RockYou2021](https://github.com/ohmybahgosh/RockYou2021.txt) ⭐ 998 | 🐛 4 | 📅 2024-03-10 -  RockYou2021.txt is a MASSIVE WORDLIST compiled of various other wordlists.
...
* [pdfrip](https://github.com/mufeedvh/pdfrip) ⭐ 1,340 | 🐛 15 | 🌐 Rust | 📅 2026-03-26 - A multi-threaded PDF password cracking utility equipped with commonly encountered password format builders and dictionary attacks.
