...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 909 | 🐛 0 | 📅 2026-03-15 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 909 | 🐛 0 | 📅 2026-03-15
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,349 | 🐛 1 | 🌐 C | 📅 2026-03-27 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 25,650 | 🐛 319 | 🌐 C | 📅 2026-02-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*
...
* [clem9669 rules](https://github.com/clem9669/hashcat-rule) ⭐ 461 | 🐛 0 | 📅 2024-09-02 - Rule for hashcat or john.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 12,904 | 🐛 495 | 🌐 C | 📅 2026-03-20 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 5,831 | 🐛 48 | 🌐 Python | 📅 2025-12-26 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,403 | 🐛 40 | 🌐 C | 📅 2026-03-23 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 318 | 🐛 5 | 📅 2026-03-27 - This project aim to provide french word list about everything a person could use as a base password.
