...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 885 | 🐛 0 | 📅 2025-06-06 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 885 | 🐛 0 | 📅 2025-06-06
...
* [NPK](https://github.com/c6fc/npk) ⭐ 651 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-13 - NPK is a distributed hash-cracking platform built entirely of serverless components in AWS including Cognito, DynamoDB, and S3.
* [Cloudtopolis](https://github.com/JoelGMSec/Cloudtopolis) ⭐ 415 | 🐛 2 | 🌐 PowerShell | 📅 2024-08-22 - A tool that facilitates the installation and provisioning of Hashtopolis on the Google Cloud Shell platform, quickly and completely unattended (and also, free!).
...
* [7z2hashcat](https://github.com/philsmd/7z2hashcat) ⭐ 424 | 🐛 4 | 🌐 Perl | 📅 2024-06-15 - Extract information from password-protected .7z archives (and .sfx files) such that you can crack these "hashes" with hashcat.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 25,452 | 🐛 299 | 🌐 C | 📅 2025-11-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,547 | 🐛 19 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,802 | 🐛 0 | 🌐 Python | 📅 2026-02-19 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,716 | 🐛 231 | 🌐 PHP | 📅 2026-02-19 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [OneRuleToRuleThemAll](https://github.com/NotSoSecure/password_cracking_rules) ⭐ 1,602 | 🐛 6 | 📅 2021-12-09 - "One rule to crack all passwords. or atleast we hope so."
...
* [OneRuleToRuleThemStill](https://github.com/stealthsploit/OneRuleToRuleThemStill) ⭐ 601 | 🐛 0 | 📅 2024-10-16 - "A revamped and updated version of my original OneRuleToRuleThemAll hashcat rule."
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 12,748 | 🐛 491 | 🌐 C | 📅 2026-01-17 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 5,762 | 🐛 47 | 🌐 Python | 📅 2025-12-26 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,359 | 🐛 39 | 🌐 C | 📅 2025-12-26 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
* [Mentalist](https://github.com/sc0tfree/mentalist) ⭐ 1,956 | 🐛 8 | 🌐 Python | 📅 2025-11-17 - Mentalist is a graphical tool for custom wordlist generation. It utilizes common human paradigms for constructing passwords and can output the full wordlist as well as rules compatible with Hashcat and John the Ripper.
...
* [kwprocessor](https://github.com/hashcat/kwprocessor) ⭐ 596 | 🐛 7 | 🌐 C | 📅 2025-08-19 - Advanced keyboard-walk generator with configureable basechars, keymap and routes.
* [maskprocessor](https://github.com/hashcat/maskprocessor/) ⭐ 496 | 🐛 14 | 🌐 C | 📅 2022-06-20 - High-performance word generator with a per-position configureable charset.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 315 | 🐛 5 | 📅 2026-02-19 - This project aim to provide french word list about everything a person could use as a base password.
...
* [pdfrip](https://github.com/mufeedvh/pdfrip) ⭐ 1,305 | 🐛 45 | 🌐 Rust | 📅 2025-11-13 - A multi-threaded PDF password cracking utility equipped with commonly encountered password format builders and dictionary attacks.
