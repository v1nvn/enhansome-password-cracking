...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 848 | 🐛 0 | 📅 2025-06-06 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 848 | 🐛 0 | 📅 2025-06-06
* If in doubt, use [awesome-lint](https://github.com/sindresorhus/awesome-lint) ⭐ 732 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-30
...
* [Cloudtopolis](https://github.com/JoelGMSec/Cloudtopolis) ⭐ 413 | 🐛 2 | 🌐 PowerShell | 📅 2024-08-22 - A tool that facilitates the installation and provisioning of Hashtopolis on the Google Cloud Shell platform, quickly and completely unattended (and also, free!).
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,317 | 🐛 1 | 🌐 C | 📅 2026-02-08 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
* [7z2hashcat](https://github.com/philsmd/7z2hashcat) ⭐ 423 | 🐛 4 | 🌐 Perl | 📅 2024-06-15 - Extract information from password-protected .7z archives (and .sfx files) such that you can crack these "hashes" with hashcat.
* [itunes\_backup2hashcat](https://github.com/philsmd/itunes_backup2hashcat) ⭐ 114 | 🐛 0 | 🌐 Perl | 📅 2017-02-04 - Extract the information needed from the Manifest.plist files to convert it to hashes compatible with hashcat.
* [WINHELLO2hashcat](https://github.com/Banaanhangwagen/WINHELLO2hashcat) ⭐ 81 | 🐛 1 | 🌐 Python | 📅 2022-04-22 - With this tool one can extract the "hash" from a WINDOWS HELLO PIN. This hash can be cracked with Hashcat.
...
* [NetNTLM-Hashcat](https://github.com/ins1gn1a/NetNTLM-Hashcat) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2019-11-24 - Converts John The Ripper/Cain format hashes (singular, or in bulk) to HashCat compatible hash format.
* [bitwarden2hashcat](https://github.com/0x6470/bitwarden2hashcat) ⭐ 26 | 🐛 2 | 🌐 Python | 📅 2022-03-17 - A tool that converts Bitwarden's data into a hashcat-suitable hash.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 25,382 | 🐛 298 | 🌐 C | 📅 2025-11-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,545 | 🐛 19 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [docker-hashcat](https://github.com/dizcza/docker-hashcat) ⭐ 155 | 🐛 2 | 🌐 Dockerfile | 📅 2025-08-19 - Latest hashcat docker for Ubuntu 18.04 CUDA, OpenCL, and POCL.
* [Hashcat-Stuffs](https://github.com/xfox64x/Hashcat-Stuffs) ⭐ 51 | 🐛 0 | 🌐 PowerShell | 📅 2019-12-18 - Collection of hashcat lists and things.
...
* [Hashfilter](https://github.com/bharshbarger/Hashfilter) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2018-04-06 - Read a hashcat potfile and parse different types into a sqlite database.

### Automation

* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,797 | 🐛 3 | 🌐 Python | 📅 2026-02-07 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
* [Naive hashcat](https://github.com/brannondorsey/naive-hashcat) ⭐ 1,377 | 🐛 11 | 🌐 C | 📅 2022-01-10 - Naive hashcat is a plug-and-play script that is pre-configured with naive, emperically-tested, "good enough" parameters/attack types.
* [hat](https://github.com/sp00ks-git/hat) ⭐ 304 | 🐛 1 | 🌐 Python | 📅 2024-06-14 - An Automated Hashcat Tool for common wordlists and rules to speed up the process of cracking hashes during engagements.
* [autocrack](https://github.com/timbo05sec/autocrack) ⭐ 118 | 🐛 0 | 🌐 Python | 📅 2018-04-16 - Hashcat wrapper to help automate the cracking process.

### Distributed cracking

* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,711 | 🐛 238 | 🌐 PHP | 📅 2026-02-06 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [fitcrack](https://github.com/nesfit/fitcrack) ⭐ 169 | 🐛 23 | 🌐 C | 📅 2025-06-29 - A hashcat-based distributed password cracking system.
...
* [OneRuleToRuleThemAll](https://github.com/NotSoSecure/password_cracking_rules) ⭐ 1,598 | 🐛 6 | 📅 2021-12-09 - "One rule to crack all passwords. or atleast we hope so."
...
* [Kaonashi](https://github.com/kaonashi-passwords/Kaonashi) ⭐ 1,080 | 🐛 1 | 📅 2022-04-22 - Wordlist, rules and masks from Kaonashi project (RootedCON 2019).
* [OneRuleToRuleThemStill](https://github.com/stealthsploit/OneRuleToRuleThemStill) ⭐ 589 | 🐛 0 | 📅 2024-10-16 - "A revamped and updated version of my original OneRuleToRuleThemAll hashcat rule."
* [nsa-rules](https://github.com/NSAKEY/nsa-rules) ⭐ 561 | 🐛 0 | 🌐 Shell | 📅 2017-01-03 - Password cracking rules and masks for hashcat generated from cracked passwords.
* [clem9669 rules](https://github.com/clem9669/hashcat-rule) ⭐ 459 | 🐛 0 | 📅 2024-09-02 - Rule for hashcat or john.
* [pantagrule](https://github.com/rarecoil/pantagrule) ⭐ 399 | 🐛 0 | 📅 2020-11-26 - Large hashcat rulesets generated from real-world compromised passwords.
* [hashcat rules collection](https://github.com/narkopolo/hashcat-rules-collection) ⭐ 137 | 🐛 0 | 📅 2026-01-16 - Probably the largest collection of hashcat rules out there.
* [nyxgeek-rules](https://github.com/nyxgeek/nyxgeek-rules) ⭐ 92 | 🐛 0 | 🌐 Shell | 📅 2024-08-19 - Custom password cracking rules for Hashcat and John the Ripper.

### Rule tools

* [duprule](https://github.com/mhasbini/duprule) ⭐ 47 | 🐛 4 | 🌐 Rust | 📅 2025-01-14 - Detect & filter duplicate hashcat rules.
* [ruleprocessorY](https://github.com/TheWorkingDeveloper/ruleprocessorY) ⭐ 35 | 🐛 4 | 🌐 C++ | 📅 2025-11-25 - A next-gen Rule processor with complex multibyte character support built to support Hashcat.

### Web interfaces

* [CrackQ](https://github.com/f0cker/crackq) ⭐ 941 | 🐛 10 | 🌐 Python | 📅 2024-09-03 - A Python Hashcat cracking queue system.
* [Hashview](https://github.com/hashview/hashview) ⭐ 387 | 🐛 60 | 🌐 Python | 📅 2026-02-04 - A web front-end for password cracking and analytics.
* [crackerjack](https://github.com/ctxis/crackerjack) ⭐ 381 | 🐛 8 | 🌐 Python | 📅 2024-02-01 - CrackerJack is a Web GUI for Hashcat developed in Python.
* [WebHashCat](https://github.com/hegusung/WebHashcat) ⭐ 322 | 🐛 13 | 🌐 Python | 📅 2025-03-07 - WebHashcat is a very simple but efficient web interface for hashcat password cracking tool.
* [Wavecrack](https://github.com/wavestone-cdt/wavecrack) ⭐ 171 | 🐛 1 | 🌐 Python | 📅 2021-09-09 - Wavestone's web interface for password cracking with hashcat.
* [hashpass](https://github.com/dj-zombie/hashpass) ⭐ 47 | 🐛 2 | 🌐 Vue | 📅 2022-07-20 - Hash cracking WebApp & Server for hashcat.

## John the Ripper

*[John the Ripper](https://github.com/openwall/john) ⭐ 12,684 | 🐛 487 | 🌐 C | 📅 2026-01-17 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*

* [BitCracker](https://github.com/e-ago/bitcracker) ⭐ 934 | 🐛 57 | 🌐 C | 📅 2024-05-31 - BitCracker is the first open source password cracking tool for memory units encrypted with BitLocker.
* [johnny](https://github.com/openwall/johnny) ⭐ 617 | 🐛 20 | 🌐 C++ | 📅 2023-09-29 - GUI frontend to John the Ripper.

## Misc

* [Name That Hash](https://github.com/HashPals/Name-That-Hash) ⭐ 1,630 | 🐛 7 | 🌐 Python | 📅 2025-12-19 - Don't know what type of hash it is? Name That Hash will name that hash type! Identify MD5, SHA256 and 300+ other hashes. Comes with a neat web app.
* [hashgen](https://github.com/cyclone-github/hashgen) ⭐ 40 | 🐛 0 | 🌐 Go | 📅 2026-01-23 - Hashgen is a simple yet very fast CLI hash generator written in Go and cross compiled for Linux, Windows & Mac.
* [Hashes](https://github.com/zefr0x/hashes) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2025-05-23 - Identify hashing algorithms (GUI frontend for Name That Hash).
...
* [gohashmob](https://github.com/n0kovo/gohashmob) ⭐ 13 | 🐛 0 | 🌐 Go | 📅 2023-04-16 - Go CLI app to quickly lookup hashes using the HashMob API.
...
* [PACK](https://github.com/iphelix/pack) ⭐ 868 | 🐛 9 | 🌐 Python | 📅 2019-12-10 - A collection of utilities developed to aid in analysis of password lists in order to enhance password cracking through pattern detection of masks, rules, character-sets and other password characteristics.
* [Pipal](https://github.com/digininja/pipal) ⭐ 660 | 🐛 8 | 🌐 Ruby | 📅 2023-08-27 - THE password analyser.
* [pcfg\_cracker](https://github.com/lakiw/pcfg_cracker) ⭐ 364 | 🐛 12 | 🌐 Python | 📅 2025-09-02 - This project uses machine learning to identify password creation habits of users.
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 5,736 | 🐛 48 | 🌐 Python | 📅 2025-12-26 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,338 | 🐛 38 | 🌐 C | 📅 2025-12-26 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
* [Mentalist](https://github.com/sc0tfree/mentalist) ⭐ 1,950 | 🐛 8 | 🌐 Python | 📅 2025-11-17 - Mentalist is a graphical tool for custom wordlist generation. It utilizes common human paradigms for constructing passwords and can output the full wordlist as well as rules compatible with Hashcat and John the Ripper.
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,605 | 🐛 9 | 🌐 Go | 📅 2024-01-12 - Append lines from stdin to a file, but only if they don't already appear in the file. Outputs new lines to stdout too, making it a bit like a tee -a that removes duplicates.
* [bopscrk](https://github.com/r3nt0n/bopscrk) ⭐ 1,056 | 🐛 7 | 🌐 Python | 📅 2024-09-07 - Generate smart and powerful wordlists for targeted attacks. Includes song lyrics fetching and different transforms.
* [duplicut](https://github.com/nil0x42/duplicut) ⭐ 966 | 🐛 6 | 🌐 C++ | 📅 2025-11-04 - Remove duplicates from MASSIVE wordlist, without sorting it (for dictionary-based password cracking).
* [Elpscrk](https://github.com/D4Vinci/elpscrk) ⭐ 914 | 🐛 2 | 🌐 Python | 📅 2024-10-14 - Elpscrk is like cupp, but it's based on permutations and statistics while being memory efficient.
* [kwprocessor](https://github.com/hashcat/kwprocessor) ⭐ 594 | 🐛 7 | 🌐 C | 📅 2025-08-19 - Advanced keyboard-walk generator with configureable basechars, keymap and routes.
* [maskprocessor](https://github.com/hashcat/maskprocessor/) ⭐ 493 | 🐛 14 | 🌐 C | 📅 2022-06-20 - High-performance word generator with a per-position configureable charset.
* [princeprocessor](https://github.com/hashcat/princeprocessor) ⭐ 479 | 🐛 9 | 🌐 C | 📅 2023-10-30 - Standalone password candidate generator using the PRINCE algorithm.
* [Gorilla](https://github.com/d4rckh/gorilla) ⭐ 392 | 🐛 5 | 🌐 Rust | 📅 2026-02-01 - Tool for generating wordlists or extending an existing one using mutations.
* [statsprocessor](https://github.com/hashcat/statsprocessor/) ⭐ 186 | 🐛 1 | 🌐 C | 📅 2023-10-27 - Word generator based on per-position markov-chains.
* [TTPassGen](https://github.com/tp7309/TTPassGen) ⭐ 167 | 🐛 1 | 🌐 Python | 📅 2025-06-11 - Flexible and scriptable password dictionary generator which supportss brute-force, combination, complex rule modes etc.
...
* [token-reverser](https://github.com/dariusztytko/token-reverser) ⭐ 111 | 🐛 1 | 🌐 Python | 📅 2020-05-20 - Words list generator to crack security tokens.
* [Rling](https://github.com/Cynosureprime/rling) ⭐ 94 | 🐛 19 | 🌐 C | 📅 2025-07-29 - RLI Next Gen (Rling), a faster multi-threaded, feature rich alternative to rli found in hashcat utilities.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 311 | 🐛 5 | 📅 2026-02-08 - This project aim to provide french word list about everything a person could use as a base password.
...
* [RockYou2021](https://github.com/ohmybahgosh/RockYou2021.txt) ⭐ 991 | 🐛 4 | 📅 2024-03-10 - 	RockYou2021.txt is a MASSIVE WORDLIST compiled of various other wordlists.
...
* [pdfrip](https://github.com/mufeedvh/pdfrip) ⭐ 1,301 | 🐛 44 | 🌐 Rust | 📅 2025-11-13 - A multi-threaded PDF password cracking utility equipped with commonly encountered password format builders and dictionary attacks.
...
* [bkcrack](https://github.com/kimci86/bkcrack) ⭐ 2,068 | 🐛 14 | 🌐 C++ | 📅 2025-11-13 - Crack legacy zip encryption with Biham and Kocher's known plaintext attack.
* [frackzip](https://github.com/hyc/fcrackzip) ⚠️ Archived - Small tool for cracking encrypted ZIP archives.

## Artificial Intelligence

* [neural network cracking](https://github.com/cupslab/neural_network_cracking) ⭐ 241 | 🐛 16 | 🌐 JavaScript | 📅 2019-12-02 - Code for cracking passwords with neural networks.
...
* [PassGPT](https://github.com/javirandor/passgpt) ⭐ 86 | 🐛 3 | 🌐 Python | 📅 2025-03-13 - PassGPT is a GPT-2 model trained from scratch on password leaks.
